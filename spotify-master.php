...
// HOOK WIDGET
require_once('includes/spotify-master-widget.php');
	...
	class spotify_master{
		...
		*/
		public static function options_page()
		{
			...
			include(self::file_path('includes/spotify-master-admin.php'));
		}
		/** function/method
		* Usage: show options/settings form page
		* Arg(0): null
		...
		*/
		...
		{
			// display widget page
			include(self::file_path('includes/spotify-master-widget.php'));
		}
		/** function/method
