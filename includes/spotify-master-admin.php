...
<tr>
<td width="387">
<img src="<?php echo plugins_url('../images/techgasp-spotifymaster-logo.png', __FILE__); ?>" alt="Spotify Master" align="left" width="387px" height="171px" style="padding:5px;"/>
</td>
<td width="0,5"></td>
<td width="700">
...
<h2><?php _e("Spotify Master LITE Version", 'spotify_master'); ?></h2>
<br>
...
<p class="submit"><input class='button-primary' type='submit' name='update' value='<?php _e("Save Settings", 'spotify_master'); ?>' id='submitbutton' /></p>
...
<div class="description">All LITE widget options are available in your widgets page. <b>Spotify Master Widget</b>.</div>
...
<div class="description">The shortcode framework allows you to insert Spotify Master inside Pages & Posts without the need of extra plugins or gimmicks. Fast page load times and top SEO. Only available in <b>Spotify Master Advanced Version</b>.</div>
<br>
<div style="background: url(<?php echo plugins_url('../images/techgasp-hr.png', __FILE__); ?>) repeat-x; height: 10px"></div>
