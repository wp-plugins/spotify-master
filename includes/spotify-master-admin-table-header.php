...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="387"><img src="<?php echo plugins_url('../images/techgasp-spotifymaster-logo.png', __FILE__); ?>" alt="Spotify Master" align="left" width="387px" height="171px" style="padding:5px;"/></td>
