...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-spotifymaster-admin-addons-widget-buttons.png', __FILE__); ?>" alt="<?php echo get_option('spotify_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			...
			<td class="column-columnname" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-check-yes.png', __FILE__); ?>" alt="<?php echo get_option('spotify_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-spotifymaster-admin-addons-widget-basic.png', __FILE__); ?>" alt="<?php echo get_option('spotify_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			...
			<td class="column-columnname" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-check-no.png', __FILE__); ?>" alt="<?php echo get_option('spotify_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-spotifymaster-admin-addons-widget-advanced.png', __FILE__); ?>" alt="<?php echo get_option('spotify_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-spotifymaster-admin-addons-shortcode-in.png', __FILE__); ?>" alt="<?php echo get_option('spotify_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-spotifymaster-admin-addons-shortcode-un.png', __FILE__); ?>" alt="<?php echo get_option('spotify_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-spotifymaster-admin-addons-updater.png', __FILE__); ?>" alt="<?php echo get_option('spotify_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-spotifymaster-admin-addons-support.png', __FILE__); ?>" alt="<?php echo get_option('spotify_master_name'); ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
