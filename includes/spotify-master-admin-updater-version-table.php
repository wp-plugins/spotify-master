...
if(get_site_option( 'spotify_master_installed_version')  == get_site_option( 'spotify_master_newest_version' )){
	echo '<img src="'.plugins_url('../images/techgasp-check-yes.png', __FILE__).'" alt="Spotify Master" width="90px" style="vertical-align:bottom" /></td>';
}
else{
	echo '<img src="'.plugins_url('../images/techgasp-check-no.png', __FILE__).'" alt="Spotify Master" width="90px" style="vertical-align:bottom" /></td>';
}
?>
		</tr>
	</tbody>
