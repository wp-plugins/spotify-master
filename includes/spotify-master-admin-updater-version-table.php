...
class spotify_master_admin_updater_version_table extends WP_List_Table {
	/**
...
<table class="widefat fixed" cellspacing="0">
	...
	<tfoot>
		<tr>
			...
			<th class="manage-column column-columnname" scope="col">
			<?php
if(get_site_option( 'spotify_master_installed_version')  == get_site_option( 'spotify_master_newest_version' )){
	echo '</td>';
}
else{
...
<?php
if( is_multisite() ) {
echo '<h3>Version '.get_site_option( 'spotify_master_installed_version' ).'</h3>';
}
else{
echo '<h3>Version '.get_option( 'spotify_master_installed_version' ).'</h3>';
}
?>
		</td>
			<td class="column-columnname" style="vertical-align:middle">
...
if(get_site_option( 'spotify_master_installed_version')  == get_site_option( 'spotify_master_newest_version' )){
	echo '<img src="'.plugins_url('../images/techgasp-check-yes.png', __FILE__).'" alt="'.get_option('spotify_master_name').'" width="90px" style="vertical-align:bottom" /></td>';
}
else{
	echo '<img src="'.plugins_url('../images/techgasp-check-no.png', __FILE__).'" alt="'.get_option('spotify_master_name').'" width="90px" style="vertical-align:bottom" /></td>';
}
?>
		</tr>
	</tbody>
